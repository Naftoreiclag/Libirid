...
int main()
{
    ...
    std::cout << "  Entering Foo makes classes CommandFoo.cpp and CommandFoo.h in src/command/" << std::endl;
    std::cout << "  Entering Bar makes classes CommandBar.cpp and CommandBar.h in src/command/" << std::endl;
    std::string name;
    std::cin >> name;
